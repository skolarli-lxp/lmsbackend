...
public interface QuestionBankTrueOrFalseRepository extends
    TenantableRepository<BankQuestionTrueOrFalse> {

    @Query("SELECT q FROM BankQuestionTrueOrFalse q "
    ...
    List<BankQuestionTrueOrFalse> findQuestionsByParameters(Double courseId, Double batchId,
